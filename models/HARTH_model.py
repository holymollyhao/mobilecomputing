...
conf.args.gpu_idx = 0
conf.args.opt = {}
conf.args.opt['num_class'] = conf.HARTHOpt['num_class']
...
input_channel_dim = 3 # back or thigh
...
class Extractor(nn.Module):
    ...
    def __init__(self):
        ...
        self.feature = nn.Sequential(
            ...
            #model just following convolutinos
    ...
    def forward(self, input):
        # print(f'current input size is : {input.size()}')
        out = self.feature(input)
...
class Extractor_DSBN(nn.Module):
    ...
    def __init__(self, num_domains):
        ...
        self.l3 = nn.Sequential(
            nn.Conv1d(32, 64, kernel_size=3),
            nn.ReLU(True))
        self.bn3 = DomainSpecificBatchNorm1d(64, num_domains)

        self.l4 = nn.Sequential(
            nn.Conv1d(64, 64, kernel_size=3),
            nn.ReLU(True))
        self.bn4 = DomainSpecificBatchNorm1d(64, num_domains)

        self.l5 = nn.MaxPool1d(2)
