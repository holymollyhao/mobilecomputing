# borrowed from https://github.com/eriklindernoren/PyTorch-YOLOv3
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None):
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        x = x[x[..., 4] > conf_thres]  # confidence, (1,10647,13)->(41,13)
        ...
        if multi_label:
            ...
            x = torch.cat((box[i], x[i, j + 5, None], j[:, None].float()), 1) # (41,13) -> (43,6)
